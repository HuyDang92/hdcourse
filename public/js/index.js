...
const cateHeader = async () => {
    const data = await Categories.getCat("http://localhost:3000/api/categories");
    const listWrapper = document.getElementById("listCate");
    let str = "";
...
const cateSection = async () => {
    const data = await Categories.getCat("http://localhost:3000/api/categories");
    const listWrapper = document.getElementById("secCate");
    let str = "";
    for (const row of data) {
...
const courseSection = async () => {
    ...
    const listWrapper = document.getElementById("secCourses");
    let str = "";
    for (const row of data) {
...
const courseSectionNew = async () => {
    const data = await Courses.getCourses("http://localhost:3000/api/courses/new");
    const listWrapper = document.getElementById("secCoursesNew");
    let str = "";
    for (const row of data) {
        str += ` <div class="course-hot position-relative col-lg-4 col-md-6 mb-3">
                    <div class="rounded mb-1 shadow-sm">
...
const courseSectioView = async () => {
    const data = await Courses.getCourses("http://localhost:3000/api/courses/topview");
    const listWrapper = document.getElementById("secCoursesView");
    let str = "";
    for (const row of data) {
        str += ` <div class="course-hot position-relative col-lg-4 col-md-6 mb-3">
                    <div class="rounded mb-1 shadow-sm">
...
const teacherSection = async () => {
    ...
    const listWrapper = document.getElementById("secTeachers");
    let str = "";
    for (const row of data) {
